...
<div class="cover"
    ...
    <div class="stay-nav-wrapper">
        <a class="stay-nav" href="<?= site_url('stay/detail') ?>"
           style="background: url('<?= base_url('img/stay/stay-nav.png') ?>') 0 0;"></a>
        <a class="stay-nav" href="<?= site_url('stay/detail') ?>"
           style="background: url('<?= base_url('img/stay/stay-nav.png') ?>') 33% 0;"></a>
        <a class="stay-nav" href="<?= site_url('stay/detail') ?>"
           style="background: url('<?= base_url('img/stay/stay-nav.png') ?>') 66% 0;"></a>
        <a class="stay-nav" href="<?= site_url('stay/detail') ?>"
           style="background: url('<?= base_url('img/stay/stay-nav.png') ?>') 99% 0;"></a>
    </div>
</div>
<div class="box" id="bb">
